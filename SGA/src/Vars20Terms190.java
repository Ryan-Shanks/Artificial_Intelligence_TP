...
public class Vars20Terms190 implements Problem {
	@Override
	public double fitness(boolean[] candidate) {
		...
		return Math.abs(a[1] * a[2] + a[1] * a[3] + a[1] * a[4] + a[1] * a[5] + a[1] * a[6] + a[1] * a[7] + a[1] * a[8]
				...
				+ a[18] * a[20] + a[19] * a[20] + a[1] * a[18] + a[2] * a[18] + a[3] * a[18] + a[4] * a[18]
				+ a[5] * a[18] + a[6] * a[18] + a[7] * a[18] + a[8] * a[18] + a[9] * a[18] + a[10] * a[18]
				+ a[11] * a[18] + a[12] * a[18] + a[13] * a[18] + a[14] * a[18] + a[15] * a[18] + a[16] * a[18]
				+ a[17] * a[18] + a[1] * a[19] + a[2] * a[19] + a[3] * a[19] + a[4] * a[19] + a[5] * a[19]
				+ a[6] * a[19] + a[7] * a[19] + a[8] * a[19] + a[9] * a[19] + a[10] * a[19] + a[11] * a[19]
				+ a[12] * a[19] + a[13] * a[19] + a[14] * a[19] + a[15] * a[19] + a[16] * a[19] + a[17] * a[19]
				+ a[18] * a[19] + a[1] * a[20] + a[2] * a[20] + a[3] * a[20] + a[4] * a[20]);
	}
